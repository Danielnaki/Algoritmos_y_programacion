...
pago-->float-->pago
"""
lectura_anterior=int(input("Ingrese el valor de la lectura anterior del recibo "))
lectura_actual=int(input("Ingrese el valor de la lectura actual del recibo "))
