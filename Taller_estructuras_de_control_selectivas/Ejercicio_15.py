...
anemia-->str-->anemia
"""
nivel_hemoglobina=int(input("Ingrese el nivel de hemoglobina del paciente "))
sexo=str(input("Ingrese su sexo (Mujer o Hombre) "))
edad_años=int(input("Ingrese su edad en años sin meses "))
edad_meses=int(input("Ingrese su edad en meses si no tiene años, de lo contrario no ingresar dato "))
sexo_mujer=sexo[0]
sexo_hombre=sexo[0]
